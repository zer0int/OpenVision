...
from src.transforms import autoaugment
from src.helpers.registry import InKeyOutKey, maybe_repeat, Registry

from src.transforms.autoaugment import color, contrast, brightness, check_zero_image

from src.transforms.random_erasing import RandomErasing
...
def random_color_jitter(jitter_strength=0.5, impl='simclrv2'):
    from src.transforms.simclr_aug import color_jitter, random_apply, to_grayscale
